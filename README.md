...
<meta name="author" content="Zheer" />

<meta name="date" content="2023-11-03" />

<title>Functions to add SMDs in gtsummary tables</title>
...
<h1 class="title toc-ignore">Functions to add SMDs in gtsummary
tables</h1>
<h4 class="author">Zheer</h4>
<h4 class="date">2023-11-03</h4>

</div>


<div id="first-we-load-dependencies" class="section level5">
<h5>First, we load dependencies</h5>
<pre class="r"><code>library(gtsummary) # For creating a baseline characteristics table</code></pre>
<pre><code>## #Uighur</code></pre>
<pre class="r"><code>library(tidyverse) # For data wrangling and misc.</code></pre>
...
<div id="then-we-create-the-core-function-that-takes-the-data-and-outputs-the-smd-results" class="section level5">
<h5>Then, we create the core function that takes the data and outputs
the SMD results</h5>
<pre class="r"><code>core_smd_function &lt;- function(data, is_weighted, ref_group = FALSE) {
...
<div id="now-we-create-a-function-to-clean-the-input-data-before-use" class="section level5">
<h5>Now, we create a function to clean the input data before use</h5>
<pre class="r"><code>clean_smd_data &lt;- function(data, variable, by, tbl) {
...
<div id="this-next-function-applies-the-clean_smd_data-and-the-core_smd_function-modifying-the-output-depending-on-1-where-the-location-of-the-smds-label-or-level-is-to-be-and-2-whether-to-print-all-pairwise-smds-or-just-smds-between-a-reference-group-and-all-other-groups" class="section level5">
<h5>This next function applies the clean_smd_data() and the
core_smd_function(), modifying the output depending on 1) where the
location of the SMDs (label or level) is to be, and 2) whether to print
all pairwise SMDs or just SMDs between a reference group and all other
groups</h5>
<pre class="r"><code>applied_smd_function &lt;- function(data, variable, by, tbl, ref_group = FALSE, location = &quot;label&quot;) {
...
<div id="now-four-caller-functions-are-defined-to-call-the-applied_smd_function-with-preset-values-for-location-and-for-ref_group" class="section level5">
<h5>Now, four caller functions are defined to call the
applied_smd_function() with preset values for ´location´ and for
´ref_group´</h5>
<pre class="r"><code>pairwise_smd &lt;- function(data, variable, by, tbl, ...) {
...
<div id="finally-we-just-need-to-test-it." class="section level5">
<h5>Finally, we just need to test it.</h5>
<p>Here, we create 4 different unweighted tables:</p>
<pre class="r"><code>trial %&gt;% 
  tbl_summary(by = grade, include = c(trt, age, stage)) %&gt;%
  add_stat(fns = everything() ~ pairwise_smd, location = ~ &quot;label&quot;)</code></pre>
<div id="aqdgzitybw" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#aqdgzitybw table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#aqdgzitybw thead, #aqdgzitybw tbody, #aqdgzitybw tfoot, #aqdgzitybw tr, #aqdgzitybw td, #aqdgzitybw th {
border-style: none;
}
#aqdgzitybw p {
margin: 0;
...
#aqdgzitybw .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#aqdgzitybw .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
...
#aqdgzitybw .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#aqdgzitybw .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#aqdgzitybw .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#aqdgzitybw .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#aqdgzitybw .gt_spanner_row {
border-bottom-style: hidden;
}
#aqdgzitybw .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#aqdgzitybw .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#aqdgzitybw .gt_from_md > :first-child {
margin-top: 0;
}
#aqdgzitybw .gt_from_md > :last-child {
margin-bottom: 0;
}
#aqdgzitybw .gt_row {
padding-top: 8px;
...
#aqdgzitybw .gt_row_group_first td {
border-top-width: 2px;
}
#aqdgzitybw .gt_row_group_first th {
border-top-width: 2px;
}
#aqdgzitybw .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#aqdgzitybw .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#aqdgzitybw .gt_first_summary_row.thick {
border-top-width: 2px;
}
#aqdgzitybw .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#aqdgzitybw .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#aqdgzitybw .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#aqdgzitybw .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#aqdgzitybw .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#aqdgzitybw .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#aqdgzitybw .gt_font_normal {
font-weight: normal;
}
#aqdgzitybw .gt_font_bold {
font-weight: bold;
}
#aqdgzitybw .gt_font_italic {
font-style: italic;
}
#aqdgzitybw .gt_super {
font-size: 65%;
}
#aqdgzitybw .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#aqdgzitybw .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#aqdgzitybw .gt_indent_1 {
text-indent: 5px;
}
#aqdgzitybw .gt_indent_2 {
text-indent: 10px;
}
#aqdgzitybw .gt_indent_3 {
text-indent: 15px;
}
#aqdgzitybw .gt_indent_4 {
text-indent: 20px;
}
#aqdgzitybw .gt_indent_5 {
text-indent: 25px;
}
</style>
...
<pre class="r"><code>trial %&gt;% 
  tbl_summary(by = grade, include = c(trt, age, stage)) %&gt;%
  add_stat(fns = everything() ~ pairwise_smd_level, location = ~ &quot;level&quot;)</code></pre>
<div id="wliugvdqav" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#wliugvdqav table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#wliugvdqav thead, #wliugvdqav tbody, #wliugvdqav tfoot, #wliugvdqav tr, #wliugvdqav td, #wliugvdqav th {
border-style: none;
}
#wliugvdqav p {
margin: 0;
...
#wliugvdqav .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#wliugvdqav .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#wliugvdqav .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#wliugvdqav .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#wliugvdqav .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#wliugvdqav .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#wliugvdqav .gt_spanner_row {
border-bottom-style: hidden;
}
#wliugvdqav .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#wliugvdqav .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#wliugvdqav .gt_from_md > :first-child {
margin-top: 0;
}
#wliugvdqav .gt_from_md > :last-child {
margin-bottom: 0;
}
#wliugvdqav .gt_row {
padding-top: 8px;
...
#wliugvdqav .gt_row_group_first td {
border-top-width: 2px;
}
#wliugvdqav .gt_row_group_first th {
border-top-width: 2px;
}
#wliugvdqav .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#wliugvdqav .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#wliugvdqav .gt_first_summary_row.thick {
border-top-width: 2px;
}
#wliugvdqav .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#wliugvdqav .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#wliugvdqav .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#wliugvdqav .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#wliugvdqav .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#wliugvdqav .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#wliugvdqav .gt_font_normal {
font-weight: normal;
}
#wliugvdqav .gt_font_bold {
font-weight: bold;
}
#wliugvdqav .gt_font_italic {
font-style: italic;
}
#wliugvdqav .gt_super {
font-size: 65%;
}
#wliugvdqav .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#wliugvdqav .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#wliugvdqav .gt_indent_1 {
text-indent: 5px;
}
#wliugvdqav .gt_indent_2 {
text-indent: 10px;
}
#wliugvdqav .gt_indent_3 {
text-indent: 15px;
}
#wliugvdqav .gt_indent_4 {
text-indent: 20px;
}
#wliugvdqav .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<pre class="r"><code>trial %&gt;% 
  tbl_summary(by = grade, include = c(trt, age, stage)) %&gt;%
  add_stat(fns = everything() ~ focal_smd, location = ~ &quot;label&quot;)</code></pre>
<div id="awvrauigwx" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#awvrauigwx table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#awvrauigwx thead, #awvrauigwx tbody, #awvrauigwx tfoot, #awvrauigwx tr, #awvrauigwx td, #awvrauigwx th {
border-style: none;
}
#awvrauigwx p {
margin: 0;
...
#awvrauigwx .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#awvrauigwx .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#awvrauigwx .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#awvrauigwx .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#awvrauigwx .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#awvrauigwx .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#awvrauigwx .gt_spanner_row {
border-bottom-style: hidden;
}
#awvrauigwx .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#awvrauigwx .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#awvrauigwx .gt_from_md > :first-child {
margin-top: 0;
}
#awvrauigwx .gt_from_md > :last-child {
margin-bottom: 0;
}
#awvrauigwx .gt_row {
padding-top: 8px;
...
#awvrauigwx .gt_row_group_first td {
border-top-width: 2px;
}
#awvrauigwx .gt_row_group_first th {
border-top-width: 2px;
}
#awvrauigwx .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#awvrauigwx .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#awvrauigwx .gt_first_summary_row.thick {
border-top-width: 2px;
}
#awvrauigwx .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#awvrauigwx .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#awvrauigwx .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#awvrauigwx .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#awvrauigwx .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#awvrauigwx .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#awvrauigwx .gt_font_normal {
font-weight: normal;
}
#awvrauigwx .gt_font_bold {
font-weight: bold;
}
#awvrauigwx .gt_font_italic {
font-style: italic;
}
#awvrauigwx .gt_super {
font-size: 65%;
}
#awvrauigwx .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#awvrauigwx .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#awvrauigwx .gt_indent_1 {
text-indent: 5px;
}
#awvrauigwx .gt_indent_2 {
text-indent: 10px;
}
#awvrauigwx .gt_indent_3 {
text-indent: 15px;
}
#awvrauigwx .gt_indent_4 {
text-indent: 20px;
}
#awvrauigwx .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<pre class="r"><code>trial %&gt;% 
  tbl_summary(by = grade, include = c(trt, age, stage)) %&gt;%
  add_stat(fns = everything() ~ focal_smd_level, location = ~ &quot;level&quot;)</code></pre>
<div id="gngumztgsj" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#gngumztgsj table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#gngumztgsj thead, #gngumztgsj tbody, #gngumztgsj tfoot, #gngumztgsj tr, #gngumztgsj td, #gngumztgsj th {
border-style: none;
}
#gngumztgsj p {
margin: 0;
...
#gngumztgsj .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#gngumztgsj .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#gngumztgsj .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#gngumztgsj .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#gngumztgsj .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#gngumztgsj .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#gngumztgsj .gt_spanner_row {
border-bottom-style: hidden;
}
#gngumztgsj .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#gngumztgsj .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#gngumztgsj .gt_from_md > :first-child {
margin-top: 0;
}
#gngumztgsj .gt_from_md > :last-child {
margin-bottom: 0;
}
#gngumztgsj .gt_row {
padding-top: 8px;
...
#gngumztgsj .gt_row_group_first td {
border-top-width: 2px;
}
#gngumztgsj .gt_row_group_first th {
border-top-width: 2px;
}
#gngumztgsj .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#gngumztgsj .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#gngumztgsj .gt_first_summary_row.thick {
border-top-width: 2px;
}
#gngumztgsj .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#gngumztgsj .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#gngumztgsj .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#gngumztgsj .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#gngumztgsj .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#gngumztgsj .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#gngumztgsj .gt_font_normal {
font-weight: normal;
}
#gngumztgsj .gt_font_bold {
font-weight: bold;
}
#gngumztgsj .gt_font_italic {
font-style: italic;
}
#gngumztgsj .gt_super {
font-size: 65%;
}
#gngumztgsj .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#gngumztgsj .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#gngumztgsj .gt_indent_1 {
text-indent: 5px;
}
#gngumztgsj .gt_indent_2 {
text-indent: 10px;
}
#gngumztgsj .gt_indent_3 {
text-indent: 15px;
}
#gngumztgsj .gt_indent_4 {
text-indent: 20px;
}
#gngumztgsj .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<p>Here, we create 4 weighted tables:</p>
...
## 
##     dotchart</code></pre>
<pre class="r"><code>survey_obj &lt;- trial %&gt;% mutate(
  w = weightit(grade ~ age + stage + trt, data = .)$weights) %&gt;%
  survey::svydesign(~1, data = ., weights = ~w) </code></pre>
<pre><code>## Warning: There was 1 warning in `mutate()`.
## ℹ In argument: `w = weightit(grade ~ age + stage + trt, data = .)$weights`.
## Caused by warning:
## ! Missing values are present in the covariates. See `?WeightIt::method_glm` for information on how these are handled.</code></pre>
<pre class="r"><code>survey_obj %&gt;%
  tbl_svysummary(by = grade, include = c(trt, age, stage)) %&gt;% 
  add_stat(fns = everything() ~ pairwise_smd) </code></pre>
<div id="ezcjrpgnko" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#ezcjrpgnko table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#ezcjrpgnko thead, #ezcjrpgnko tbody, #ezcjrpgnko tfoot, #ezcjrpgnko tr, #ezcjrpgnko td, #ezcjrpgnko th {
border-style: none;
}
#ezcjrpgnko p {
margin: 0;
...
#ezcjrpgnko .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#ezcjrpgnko .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#ezcjrpgnko .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#ezcjrpgnko .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#ezcjrpgnko .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#ezcjrpgnko .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#ezcjrpgnko .gt_spanner_row {
border-bottom-style: hidden;
}
#ezcjrpgnko .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#ezcjrpgnko .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#ezcjrpgnko .gt_from_md > :first-child {
margin-top: 0;
}
#ezcjrpgnko .gt_from_md > :last-child {
margin-bottom: 0;
}
#ezcjrpgnko .gt_row {
padding-top: 8px;
...
#ezcjrpgnko .gt_row_group_first td {
border-top-width: 2px;
}
#ezcjrpgnko .gt_row_group_first th {
border-top-width: 2px;
}
#ezcjrpgnko .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#ezcjrpgnko .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#ezcjrpgnko .gt_first_summary_row.thick {
border-top-width: 2px;
}
#ezcjrpgnko .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#ezcjrpgnko .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#ezcjrpgnko .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#ezcjrpgnko .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#ezcjrpgnko .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#ezcjrpgnko .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#ezcjrpgnko .gt_font_normal {
font-weight: normal;
}
#ezcjrpgnko .gt_font_bold {
font-weight: bold;
}
#ezcjrpgnko .gt_font_italic {
font-style: italic;
}
#ezcjrpgnko .gt_super {
font-size: 65%;
}
#ezcjrpgnko .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#ezcjrpgnko .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#ezcjrpgnko .gt_indent_1 {
text-indent: 5px;
}
#ezcjrpgnko .gt_indent_2 {
text-indent: 10px;
}
#ezcjrpgnko .gt_indent_3 {
text-indent: 15px;
}
#ezcjrpgnko .gt_indent_4 {
text-indent: 20px;
}
#ezcjrpgnko .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<pre class="r"><code>survey_obj %&gt;% 
  tbl_svysummary(by = grade, include = c(trt, age, stage)) %&gt;% 
  add_stat(fns = everything() ~ pairwise_smd_level, location = ~ &quot;level&quot;) </code></pre>
<div id="bzcsssemxn" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#bzcsssemxn table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#bzcsssemxn thead, #bzcsssemxn tbody, #bzcsssemxn tfoot, #bzcsssemxn tr, #bzcsssemxn td, #bzcsssemxn th {
border-style: none;
}
#bzcsssemxn p {
margin: 0;
...
#bzcsssemxn .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#bzcsssemxn .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#bzcsssemxn .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#bzcsssemxn .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#bzcsssemxn .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#bzcsssemxn .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#bzcsssemxn .gt_spanner_row {
border-bottom-style: hidden;
}
#bzcsssemxn .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bzcsssemxn .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#bzcsssemxn .gt_from_md > :first-child {
margin-top: 0;
}
#bzcsssemxn .gt_from_md > :last-child {
margin-bottom: 0;
}
#bzcsssemxn .gt_row {
padding-top: 8px;
...
#bzcsssemxn .gt_row_group_first td {
border-top-width: 2px;
}
#bzcsssemxn .gt_row_group_first th {
border-top-width: 2px;
}
#bzcsssemxn .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#bzcsssemxn .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#bzcsssemxn .gt_first_summary_row.thick {
border-top-width: 2px;
}
#bzcsssemxn .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bzcsssemxn .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#bzcsssemxn .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bzcsssemxn .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bzcsssemxn .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#bzcsssemxn .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#bzcsssemxn .gt_font_normal {
font-weight: normal;
}
#bzcsssemxn .gt_font_bold {
font-weight: bold;
}
#bzcsssemxn .gt_font_italic {
font-style: italic;
}
#bzcsssemxn .gt_super {
font-size: 65%;
}
#bzcsssemxn .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#bzcsssemxn .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#bzcsssemxn .gt_indent_1 {
text-indent: 5px;
}
#bzcsssemxn .gt_indent_2 {
text-indent: 10px;
}
#bzcsssemxn .gt_indent_3 {
text-indent: 15px;
}
#bzcsssemxn .gt_indent_4 {
text-indent: 20px;
}
#bzcsssemxn .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<pre class="r"><code>survey_obj %&gt;% 
  tbl_svysummary(by = grade, include = c(trt, age, stage)) %&gt;% 
  add_stat(fns = everything() ~ focal_smd) </code></pre>
<div id="bbviyexana" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#bbviyexana table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#bbviyexana thead, #bbviyexana tbody, #bbviyexana tfoot, #bbviyexana tr, #bbviyexana td, #bbviyexana th {
border-style: none;
}
#bbviyexana p {
margin: 0;
...
#bbviyexana .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#bbviyexana .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#bbviyexana .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#bbviyexana .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#bbviyexana .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#bbviyexana .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#bbviyexana .gt_spanner_row {
border-bottom-style: hidden;
}
#bbviyexana .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bbviyexana .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#bbviyexana .gt_from_md > :first-child {
margin-top: 0;
}
#bbviyexana .gt_from_md > :last-child {
margin-bottom: 0;
}
#bbviyexana .gt_row {
padding-top: 8px;
...
#bbviyexana .gt_row_group_first td {
border-top-width: 2px;
}
#bbviyexana .gt_row_group_first th {
border-top-width: 2px;
}
#bbviyexana .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#bbviyexana .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#bbviyexana .gt_first_summary_row.thick {
border-top-width: 2px;
}
#bbviyexana .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bbviyexana .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#bbviyexana .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bbviyexana .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#bbviyexana .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#bbviyexana .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#bbviyexana .gt_font_normal {
font-weight: normal;
}
#bbviyexana .gt_font_bold {
font-weight: bold;
}
#bbviyexana .gt_font_italic {
font-style: italic;
}
#bbviyexana .gt_super {
font-size: 65%;
}
#bbviyexana .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#bbviyexana .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#bbviyexana .gt_indent_1 {
text-indent: 5px;
}
#bbviyexana .gt_indent_2 {
text-indent: 10px;
}
#bbviyexana .gt_indent_3 {
text-indent: 15px;
}
#bbviyexana .gt_indent_4 {
text-indent: 20px;
}
#bbviyexana .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<pre class="r"><code>survey_obj %&gt;% 
  tbl_svysummary(by = grade, include = c(trt, age, stage)) %&gt;% 
  add_stat(fns = everything() ~ focal_smd_level, location = ~ &quot;level&quot;) </code></pre>
<div id="uhjdakbxze" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#uhjdakbxze table {
font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
-webkit-font-smoothing: antialiased;
-moz-osx-font-smoothing: grayscale;
}
#uhjdakbxze thead, #uhjdakbxze tbody, #uhjdakbxze tfoot, #uhjdakbxze tr, #uhjdakbxze td, #uhjdakbxze th {
border-style: none;
}
#uhjdakbxze p {
margin: 0;
...
#uhjdakbxze .gt_bottom_border {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}
#uhjdakbxze .gt_col_headings {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#uhjdakbxze .gt_column_spanner_outer {
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
font-weight: normal;
...
#uhjdakbxze .gt_column_spanner_outer:first-child {
padding-left: 0;
}
#uhjdakbxze .gt_column_spanner_outer:last-child {
padding-right: 0;
}
#uhjdakbxze .gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
vertical-align: bottom;
...
#uhjdakbxze .gt_spanner_row {
border-bottom-style: hidden;
}
#uhjdakbxze .gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#uhjdakbxze .gt_empty_group_heading {
padding: 0.5px;
color: #333333;
background-color: #FFFFFF;
font-size: 100%;
...
#uhjdakbxze .gt_from_md > :first-child {
margin-top: 0;
}
#uhjdakbxze .gt_from_md > :last-child {
margin-bottom: 0;
}
#uhjdakbxze .gt_row {
padding-top: 8px;
...
#uhjdakbxze .gt_row_group_first td {
border-top-width: 2px;
}
#uhjdakbxze .gt_row_group_first th {
border-top-width: 2px;
}
#uhjdakbxze .gt_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#uhjdakbxze .gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}
#uhjdakbxze .gt_first_summary_row.thick {
border-top-width: 2px;
}
#uhjdakbxze .gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#uhjdakbxze .gt_grand_summary_row {
color: #333333;
background-color: #FFFFFF;
text-transform: inherit;
padding-top: 8px;
...
#uhjdakbxze .gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#uhjdakbxze .gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#uhjdakbxze .gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}
#uhjdakbxze .gt_table_body {
border-top-style: solid;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#uhjdakbxze .gt_font_normal {
font-weight: normal;
}
#uhjdakbxze .gt_font_bold {
font-weight: bold;
}
#uhjdakbxze .gt_font_italic {
font-style: italic;
}
#uhjdakbxze .gt_super {
font-size: 65%;
}
#uhjdakbxze .gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}
#uhjdakbxze .gt_asterisk {
font-size: 100%;
vertical-align: 0;
}
#uhjdakbxze .gt_indent_1 {
text-indent: 5px;
}
#uhjdakbxze .gt_indent_2 {
text-indent: 10px;
}
#uhjdakbxze .gt_indent_3 {
text-indent: 15px;
}
#uhjdakbxze .gt_indent_4 {
text-indent: 20px;
}
#uhjdakbxze .gt_indent_5 {
text-indent: 25px;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
