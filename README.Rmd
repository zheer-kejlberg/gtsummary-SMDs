...
- **pairwise_smd_level** sets *ref_group = FALSE* and *location = "level"*, meaning all possible pairs of groups are compared, and one SMD per level of cateogrical variables is returned.
- **focal_smd** sets *ref_group = TRUE* and *location = "label"*, meaning only group 1 is compared to all other groups, and one SMD per variable is returned.
